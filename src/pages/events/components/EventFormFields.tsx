        ...
        <div className="mb-4">
          ...
          <div className="row">
            ...
            <div className="col-sm-6">
              ...
              >
                <option value="">
                  {t("events.form.fields.region.placeholder")}
                </option>
          ...
          <div className="row">
            ...
            <div className="col-sm-6">
              <Select
                ...
                error={
                  formik.touched.sweepGuideId
                    ? formik.errors.sweepGuideId
                    : undefined
                }
      ...
      {activeStep === 4 && (
        <div>
          ...
          <div className="row">
            <div className="col-sm-6">
              <Input
                ...
                step="1"
                placeholder={t(
                  "events.form.fields.maxParticipants.placeholder",
                )}
            ...
            <div className="col-sm-6">
              <Select
                ...
                error={
                  formik.touched.priceType ? formik.errors.priceType : undefined
                }
              >
                <option value="">
                  {t("events.form.fields.priceType.placeholder")}
                </option>
          ...
          <Textarea
            ...
            error={
              formik.touched.whatIsNecessary
                ? formik.errors.whatIsNecessary
                : undefined
            }
          />
          ...
          <div className="row">
            <div className="col-sm-6">
              <Textarea
                ...
                error={
                  formik.touched.includedItems
                    ? formik.errors.includedItems
                    : undefined
                }
              />
            </div>
            ...
            <div className="col-sm-6">
              <Textarea
                ...
                error={
                  formik.touched.excludedItems
                    ? formik.errors.excludedItems
                    : undefined
                }
                containerClassName="mb-0"
              />
